...
export const GET = withAuth(async (request, { user, params }) => {
  try {
    ...
    const [
      ...
      cylinderLiner,
      mainBearingBore,
      mainBearingRadialClearance,
      camshaftBushing,
      mainJournal,
      crankshaftMainJournalDiameter,
      mainJournalWidth,
      conRodJournal,
      connectingRodBearingBore,
      ...
      fetchSection('ctmr_main_bearing_radial_clearance', 'ctmr_main_bearing_radial_clearance_data', 'main_bearing_radial_clearance_id'),
      ...
      fetchSection('ctmr_crankshaft_main_journal_diameter', 'ctmr_crankshaft_main_journal_diameter_data', 'crankshaft_main_journal_diameter_id'),
      ...
      fetchSection('ctmr_connecting_rod_bearing_bore', 'ctmr_connecting_rod_bearing_bore_data', 'connecting_rod_bearing_bore_id'),
    ...
    const fullRecord = {
      ...
      measurementData: {
        ...
        mainBearingRadialClearanceMeta: mainBearingRadialClearance.meta,
        mainBearingRadialClearanceData: mainBearingRadialClearance.data,
        ...
        crankshaftMainJournalDiameterMeta: crankshaftMainJournalDiameter.meta,
        crankshaftMainJournalDiameterData: crankshaftMainJournalDiameter.data,
        ...
        connectingRodBearingBoreMeta: connectingRodBearingBore.meta,
        connectingRodBearingBoreData: connectingRodBearingBore.data,
