  ...
  try {
    ...
    const addSignatures = async () => {
      const signatures = [
        ...
        { label: "Svc. Manager", title: "Noted By", name: record.noted_by_name, imageUrl: await resolveSignature(record.noted_by_signature, record.noted_by_name, record.noted_by_user_id) },
