...
const FillUpFormPage = () => {
        ...
        return (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center border border-gray-200">
            ...
            <p className="text-gray-500 max-w-sm mx-auto">
              The <span className="font-semibold text-gray-700">{
                options.find(opt => opt.value === activeForm)?.label
              }</span> is currently under development and will be available shortly.
            </p>
          </div>
        );
    }
  ...
  const options = [
    ...
    { value: 'electric-pump-commissioning', label: 'Electric Driven Pump Commissioning Report' },
    { value: 'electric-pump-service', label: 'Electric Driven Pump Service Report' },
    { value: 'electric-pump-teardown', label: 'Electric Driven Pump Teardown Report' },
    { value: 'engine-pump-commissioning', label: 'Engine Driven Pump Commissioning Report' },
    { value: 'engine-pump-service', label: 'Engine Driven Pump Service Report' },
