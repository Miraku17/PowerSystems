...
export default function DeutzCommissioningReport() {
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      ...
      // Add mapped fields
      formDataToSubmit.append('summary', formData.inspection_summary);
      formDataToSubmit.append('comments_action', formData.inspection_comments);
      ...
      const response = await apiClient.post('/forms/deutz-commissioning', formDataToSubmit, {
        headers: {
