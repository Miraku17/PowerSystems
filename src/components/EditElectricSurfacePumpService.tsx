      ...
      if (response.status === 200) {
        ...
        if (newAttachments.length > 0) {
          ...
          const results = await uploadFiles(
            ...
            { bucket: 'service-reports', pathPrefix: 'electric-surface/service' }
          );
          results.forEach((r, i) => {
            if (r.success && r.url) {
        ...
        await apiClient.post('/forms/electric-surface-pump-service/attachments', {
          report_id: recordId,
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {newAttachments.map((attachment, index) => {
                  const previewUrl = attachment.file.type.startsWith('image/') ? URL.createObjectURL(attachment.file) : '';
