...
export default function EditEngineSurfacePumpService({
  data,
  recordId,
  onClose,
  onSaved,
  ...
  useEffect(() => {
    const fetchAttachments = async () => {
      try {
        const response = await apiClient.get('/forms/engine-surface-pump-service/attachments', { params: { report_id: recordId } });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await apiClient.patch(
        `/forms/engine-surface-pump-service?id=${recordId}`,
        formData
      );
      ...
      if (response.status === 200) {
        ...
        await apiClient.post('/forms/engine-surface-pump-service/attachments', {
          report_id: recordId,
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white z-10">
          <div>
            <h3 className="text-xl font-bold text-gray-900">
              Edit Engine Driven Surface Pump Service Report
            </h3>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="bg-white shadow-sm border border-gray-200 rounded-xl p-8 max-w-5xl mx-auto space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <CustomerAutocomplete label="Reporting Person" name="reporting_person_name" value={formData.reporting_person_name} onChange={handleChange} onSelect={handleCustomerSelect} customers={customers} searchKey="name" />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <Input label="Cooling Additives" name="cooling_additives" value={formData.cooling_additives} onChange={handleChange} />
              </div>
            </div>
                ...
                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:bg-gray-50 transition-colors cursor-pointer">
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-sm text-gray-600">
                      <label htmlFor="file-upload-edit-engine-service" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500">
