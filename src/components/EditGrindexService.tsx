...
interface EditGrindexServiceProps {
...
export default function EditGrindexService({ data, recordId, onClose, onSaved }: EditGrindexServiceProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.patch(`/forms/grindex-service?id=${recordId}`, formData);
      ...
      if (response.status === 200) {
        ...
        // Update attachments
        await apiClient.post('/forms/grindex-service/attachments', formDataObj);

        toast.success('Grindex Service Form updated successfully!', { id: loadingToast });
        onSaved();
        onClose();
      }
    } catch (error: any) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: "rgba(0, 0, 0, 0.5)", backdropFilter: "blur(4px)" }}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col animate-slideUp overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white z-10">
          <div>
            <h3 className="text-xl font-bold text-gray-900">Edit Grindex Service Form</h3>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="bg-white shadow-sm border border-gray-200 rounded-xl p-8 max-w-5xl mx-auto space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Input label="KW" name="kw" value={formData.kw} onChange={handleChange} />
                ...
                <Input label="Hmax" name="hmax" value={formData.hmax} onChange={handleChange} />
                <Input label="Qmax" name="qmax" value={formData.qmax} onChange={handleChange} />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Input label="Servicing Date" name="date_in_service" type="date" value={formData.date_in_service} onChange={handleChange} />
                <Input label="Date Failed" name="date_failed" type="date" value={formData.date_failed} onChange={handleChange} />
                <Input label="Date Commissioned" name="date_commissioned" type="date" value={formData.date_commissioned} onChange={handleChange} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="flex flex-col space-y-4">
                  ...
                  />
                  {formData.service_technician_signature && formData.service_technician_signature.startsWith('http') ? (
                    <div className="flex flex-col items-center">
                      <div className="border border-gray-300 rounded-lg p-2 bg-gray-50 mb-2 w-full flex justify-center">
                        <img src={formData.service_technician_signature} alt="Signature" className="max-h-24 object-contain" />
                      </div>
                      <button
                        type="button"
                        onClick={() => handleChange("service_technician_signature", "")}
                    ...
                    <SignaturePad
                      ...
                      onChange={(val) => handleChange("service_technician_signature", val)}
                      subtitle="Sign above"
                    />
                  )}
                </div>
