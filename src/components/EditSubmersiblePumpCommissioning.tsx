...
export default function EditSubmersiblePumpCommissioning({
  data,
  recordId,
  onClose,
  onSaved,
  ...
  useEffect(() => {
    const fetchAttachments = async () => {
      try {
        const response = await apiClient.get('/forms/submersible-pump-commissioning/attachments', { params: { report_id: recordId } });
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white z-10">
          <div>
            <h3 className="text-xl font-bold text-gray-900">
              Edit Submersible Pump Commissioning Report
            </h3>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="bg-white shadow-sm border border-gray-200 rounded-xl p-8 max-w-5xl mx-auto space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Input
                  ...
                  value={formData.reporting_person_contact}
                  onChange={handleChange}
                />
                <Input
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <Input
                  label="KW Rating P1"
                  name="kw_rating_p1"
                  value={formData.kw_rating_p1}
                  onChange={handleChange}
                />
                <Input
                  label="KW Rating P2"
                  name="kw_rating_p2"
                  value={formData.kw_rating_p2}
                  onChange={handleChange}
                />
                <Input
                  label="Voltage"
                ...
                />
                <Input
                  label="Max Submerged Depth"
                  name="max_submerged_depth"
                  value={formData.max_submerged_depth}
                  onChange={handleChange}
                />
                <Input
                  label="No. of Leads"
                ...
                <div className="md:col-span-2">
                  <Input
                    label="Discharge Size/Type"
                    name="discharge_size_type"
                    value={formData.discharge_size_type}
                    onChange={handleChange}
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                />
                <Input
                  label="Submerge Depth"
                  name="submerge_depth"
                  value={formData.submerge_depth}
                  onChange={handleChange}
                />
                <Input
                  label="Length of Wire/Size"
                  name="length_of_wire_size"
                  value={formData.length_of_wire_size}
                  onChange={handleChange}
                />
                <Input
                  label="Pipe Size/Type"
                  name="pipe_size_type"
                  value={formData.pipe_size_type}
                  onChange={handleChange}
                />
                <Input
                  label="Pipe Length"
                ...
                <Input
                  label="Static Head"
                  name="static_head"
                  value={formData.static_head}
                  onChange={handleChange}
                />
                <Input
                  label="Check Valve Size/Type"
                  name="check_valve_size_type"
                  value={formData.check_valve_size_type}
                  onChange={handleChange}
                />
                <Input
                  label="No. of Elbows/Size"
                  name="no_of_elbows_size"
                  value={formData.no_of_elbows_size}
                  onChange={handleChange}
                />
                <Input
                  label="Media"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Input
                  ...
                  type="date"
                  value={formData.commissioning_date?.split("T")[0] || ""}
                  onChange={handleChange}
                />
                <Input
                  label="Power Source"
                ...
                />
                <Input
                  label="Pumping Arrangement"
                  name="pumping_arrangement"
                  value={formData.pumping_arrangement}
                  onChange={handleChange}
                />
                <Input
                  label="Controller Rating"
                  name="controller_rating"
                  value={formData.controller_rating}
                  onChange={handleChange}
                />
                <Input
                  label="Others"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Input
                  label="Voltage"
                  name="actual_voltage"
                  value={formData.actual_voltage}
                  onChange={handleChange}
                />
                <Input
                  label="Frequency"
                  name="actual_frequency"
                  value={formData.actual_frequency}
                  onChange={handleChange}
                />
                <Input
                  label="Amps"
                  name="actual_amps"
                  value={formData.actual_amps}
                  onChange={handleChange}
                />
                <Input
                ...
                <Input
                  ...
                  name="discharge_flow"
                  value={formData.discharge_flow}
                  onChange={handleChange}
                />
                <Input
                  label="Quality of Water"
                  name="quality_of_water"
                  value={formData.quality_of_water}
                  onChange={handleChange}
                />
                <Input
                  label="Water Temp"
                ...
                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:bg-gray-50 transition-colors cursor-pointer">
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-sm text-gray-600">
                      <label
                        htmlFor="file-upload-edit-submersible"
                        className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500"
                      >
                        <span>Upload an image</span>
                        <input
                          id="file-upload-edit-submersible"
                          name="file-upload-edit-submersible"
                          type="file"
                          accept="image/*"
                          className="sr-only"
                          onChange={async (e) => {
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  {formData.commissioned_by_signature && formData.commissioned_by_signature.startsWith('http') ? (
                    <div className="flex flex-col items-center">
                      ...
                      <button
                        type="button"
                        onClick={() => handleChange("commissioned_by_signature", "")}
                    ...
                    <SignaturePad
                      ...
                      onChange={(val) => handleChange("commissioned_by_signature", val)}
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  {formData.checked_approved_by_signature && formData.checked_approved_by_signature.startsWith('http') ? (
                    <div className="flex flex-col items-center">
                      ...
                      <button
                        type="button"
                        onClick={() => handleChange("checked_approved_by_signature", "")}
                        className="text-xs text-red-600 hover:text-red-800 underline"
                      >
                        Remove Signature
                      </button>
                    ...
                    <SignaturePad
                      ...
                      onChange={(val) => handleChange("checked_approved_by_signature", val)}
