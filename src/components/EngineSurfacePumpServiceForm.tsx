...
export default function EngineSurfacePumpServiceForm() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const { formData, setFormData, resetFormData } = useEngineSurfacePumpServiceFormStore();
  ...
  return (
    <div className="bg-white shadow-xl rounded-lg p-4 md:p-8 max-w-6xl mx-auto border border-gray-200 print:shadow-none print:border-none">
            ...
            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:bg-gray-50 transition-colors cursor-pointer">
              <div className="space-y-1 text-center">
                ...
                <div className="flex text-sm text-gray-600">
                  <label htmlFor="file-upload-engine-service" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 bg-gray-50 p-4 md:p-8 rounded-lg border border-gray-100">
            <div className="flex flex-col space-y-4">
              <Select label="Service Technician" name="performed_by_name" value={formData.performed_by_name} onChange={handleChange} options={allUserOptions} />
              <SignaturePad
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to submit this Engine Driven Surface Pump Service Report?"
      />
    </div>
  );
}
