...
export default function PendingJORequests() {
  ...
  const getLevelLabel = (status: string) => {
    switch (status) {
      ...
      case "pending_level_2":
        return "Level 2 (Super User)";
      case "pending_level_3":
        return "Level 3 (Admin 1)";
      default:
        return "-";
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Pending JO Requests</h1>
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row gap-4 items-center justify-between">
        ...
        <span className="text-sm text-gray-500">
          {filteredRecords.length} pending request{filteredRecords.length !== 1 ? "s" : ""}
        </span>
      </div>
