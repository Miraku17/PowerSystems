...
import { useSubmersiblePumpCommissioningFormStore } from "@/stores/submersiblePumpCommissioningFormStore";
...
export default function SubmersiblePumpCommissioningForm() {
  ...
  const { formData, setFormData, resetFormData } = useSubmersiblePumpCommissioningFormStore();
  ...
  return (
    <div className="bg-white shadow-xl rounded-lg p-4 md:p-8 max-w-6xl mx-auto border border-gray-200 print:shadow-none print:border-none">
      {/* Header */}
      <ReportHeader title="Commissioning Report" subtitle="Submersible Pump" />
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          <div className="flex items-center mb-4">
            <div className="w-1 h-6 bg-blue-600 mr-2"></div>
            <h3 className="text-lg font-bold text-gray-800 uppercase">Other Details</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 bg-gray-50 p-6 rounded-lg border border-gray-100">
        ...
        <div>
          <div className="flex items-center mb-4">
            <div className="w-1 h-6 bg-blue-600 mr-2"></div>
            <h3 className="text-lg font-bold text-gray-800 uppercase">Actual Operational Details</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 bg-gray-50 p-6 rounded-lg border border-gray-100">
            ...
            <Input label="Discharge Pressure (If available)" name="discharge_pressure" value={formData.discharge_pressure} onChange={handleChange} />
            <Input label="Discharge Flow (If available)" name="discharge_flow" value={formData.discharge_flow} onChange={handleChange} />
        ...
        <div>
          <div className="flex items-center mb-4">
            <div className="w-1 h-6 bg-blue-600 mr-2"></div>
            <h3 className="text-lg font-bold text-gray-800 uppercase">Comments</h3>
          </div>
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to submit this Submersible Pump Commissioning Report?"
      />
    </div>
  );
}
