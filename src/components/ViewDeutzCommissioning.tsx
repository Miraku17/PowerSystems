              ...
              <div className="bg-blue-50 border-l-4 border-blue-600 p-4 mb-6 rounded-md">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-2xl font-extrabold text-blue-900">{data.job_order_no || 'N/A'}</div>
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-blue-800 uppercase mb-1">Commissioning Date</label>
                    <div className="text-2xl font-extrabold text-blue-900">{data.commissioning_date || 'N/A'}</div>
                  </div>
                </div>
              </div>
