                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  <div className="flex flex-col items-center">
                    ...
                    {resolvedServiceTechnicianSig ? (
                      <div className="border border-gray-200 rounded-lg p-2 bg-white mb-2">
                        <img src={resolvedServiceTechnicianSig} alt="Service Technician Signature" className="h-24 w-auto object-contain" />
                      </div>
                    ) : (
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {resolvedApprovedBySig ? (
                      <div className="border border-gray-200 rounded-lg p-2 bg-white mb-2">
                        <img src={resolvedApprovedBySig} alt="Approved By Signature" className="h-24 w-auto object-contain" />
                      </div>
                    ) : (
                      <div className="h-24 w-full border border-dashed border-gray-300 rounded-lg flex items-center justify-center text-gray-400 text-sm mb-2">No signature</div>
                    )}
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {resolvedNotedBySig ? (
                      <div className="border border-gray-200 rounded-lg p-2 bg-white mb-2">
                        <img src={resolvedNotedBySig} alt="Noted By Signature" className="h-24 w-auto object-contain" />
                      </div>
                    ) : (
                      <div className="h-24 w-full border border-dashed border-gray-300 rounded-lg flex items-center justify-center text-gray-400 text-sm mb-2">No signature</div>
                    )}
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {resolvedAcknowledgedBySig ? (
                      <div className="border border-gray-200 rounded-lg p-2 bg-white mb-2">
                        <img src={resolvedAcknowledgedBySig} alt="Acknowledged By Signature" className="h-24 w-auto object-contain" />
                      </div>
                    ) : (
                      <div className="h-24 w-full border border-dashed border-gray-300 rounded-lg flex items-center justify-center text-gray-400 text-sm mb-2">No signature</div>
                    )}
