...
interface ViewSubmersiblePumpServiceProps {
...
export default function ViewSubmersiblePumpService({ data, onClose, onExportPDF, onSignatoryChange }: ViewSubmersiblePumpServiceProps) {
  ...
  useEffect(() => {
    const fetchAttachments = async () => {
      try {
        const attachmentResponse = await apiClient.get('/forms/submersible-pump-service/attachments', { params: { report_id: data.id } });
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col animate-slideUp overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-gray-100 bg-white z-10">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <h3 className="text-xl font-bold text-gray-900">Submersible Pump Service Report</h3>
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-gray-50/50">
          <div className="bg-white shadow-sm border border-gray-200 rounded-xl p-8 max-w-5xl mx-auto">
            ...
            {/* Company Header */}
            <ReportHeader title="Service Report" subtitle="Submersible Pump" />
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  ...
                  <Field label="Water Quality" value={data.water_quality} />
                  <Field label="Water Temperature" value={data.water_temp} />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Field label="Is within coverage period?" value={formatBoolean(data.is_within_coverage_period)} />
                  ...
                  <div className="text-center flex flex-col items-center">
                    <div className="h-24 w-full flex items-end justify-center mb-2 border-b border-gray-300 pb-2">
                      {resolvedCheckedApprovedBySig ? (
                        <img src={resolvedCheckedApprovedBySig} alt="Approved By Signature" className="max-h-20 max-w-full object-contain" />
                      ) : (
                        <span className="text-xs text-gray-400 italic mb-2">No Signature</span>
                      )}
                    </div>
                    <Field label="Approved By" value={data.checked_approved_by_name} />
