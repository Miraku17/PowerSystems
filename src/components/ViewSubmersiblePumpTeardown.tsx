...
export default function ViewSubmersiblePumpTeardown({ data, onClose, onExportPDF }: ViewSubmersiblePumpTeardownProps) {
                  ...
                  <div className="text-center flex flex-col items-center">
                    <div className="h-24 w-full flex items-end justify-center mb-2 border-b border-gray-300 pb-2">
                      {data.teardowned_by_signature ? (
                        <img src={data.teardowned_by_signature} alt="Teardowned By Signature" className="max-h-20 max-w-full object-contain" />
                      ) : (
